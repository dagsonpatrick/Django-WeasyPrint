...
ADMINLTE = os.path.join(settings.BASE_DIR,'clientes\\static\\clientes\\css\\style.css')
...
def gerar_pdf_pedidos(request):
    ...
    resultado_pdf = html.write_pdf(stylesheets=[ADMINLTE], presentational_hints=True)
